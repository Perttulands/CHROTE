...
describe('TerminalWindow launch user', () => {
  ...
  it('states a detached tile in the middle of the frame, in its own compact button shape', () => {
    poolState.connectionStates = new Map([['alice:departed', 'closed']])
    const { container } = render(
      <TerminalWindow
        workspaceId="terminal3"
    ...
    // Both actions carry the one tile-action shape; the bespoke third shape the
    // tile used to draw is gone from markup and stylesheet.

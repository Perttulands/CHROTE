...
src/internal/api/               HTTP APIs for tmux, files, Beads, schedules, services, and status
...
- Keep experimental orchestration work in `chrote-agent-formations`, outside
  CHROTE's product and release claims.

...
6. confirm Sessions open/pin/width remains global across terminal switches, Files state remains per workspace, and narrow layouts overlay at `768px` and below;

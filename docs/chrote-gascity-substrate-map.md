...
| Workflows/recipes | Roadmap only; old agent-team ideas are not current implementation | Formulas, molecules, wisps, convoys, sling, orders | Gas City-owned | Gas City owns workflow graph execution; CHROTE owns launch/observe/approval UI. |

...
func TestValidateProjectPath(t *testing.T) {
	...
	// Save original AllowedRoots and restore after test
	originalRoots := AllowedRoots
	defer func() { AllowedRoots = originalRoots }()

	// Set AllowedRoots to include our temp directory
